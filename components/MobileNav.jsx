...
function MobileNav({ balance = 0 }) {
  ...
  const navLinks = isAuthenticate ? userNavLinksMobile : guestNavLinks
      ...
      <div
        ...
        <div className="overflow-hidden">
          <div className="w-full bg-accent-dark text-white flex flex-col items-center">
            <div className="text-lg font-medium bg-accent-dark w-full flex py-2 px-4 items-center justify-between border-b border-[1px] border-white/20 h-16">
